...
class_name PlayerGroundAttack2State
...
func OnEnter():
	...
	if (CurrentEquipPlaceholder==null or CurrentEquipPlaceholder.ItemInUse.AttackPatternNode==null or CurrentEquipPlaceholder.ItemInUse.AttackPatternNode.GroundAttack2==null):
		StateParent.OnRequestStateChange.emit(StateName, Enums.PlayerState.Idle)
		return
	AttackPatternNode=CurrentEquipPlaceholder.ItemInUse.AttackPatternNode.GroundAttack2
